...
import { HomeImageBoxArr ,categery } from "./JsonData";
  ...
  return (
    <>
      <div className="row inner-section-wrapper">
        {HomeImageBoxArr.map(({ img, name, price , title }, ind) => (
      ...
      <div className="section-head text-center">
        <h2 className="title wow text-center flipInX"> خدماتنا</h2>
      </div>

      <div className="icon-wrapper1">
        <div className="row wow fadeInUp">
          {categery.map(({ img2, icon, title }, ind) => (
